...
async def _usage_insights_service():
    return services.usage_insights_service
...
app.include_router(build_usage_insights_router(_usage_insights_service))
