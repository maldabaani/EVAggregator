...
from evagg.charging_auth.session_start import SessionNotFoundError, SessionStartError, SessionStatus
...
class _FakeService:
    def __init__(self, status: SessionStatus | None = None, error: Exception | None = None) -> None:
        self.status = status
        self.error = error
